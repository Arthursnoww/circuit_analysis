...
# ╔═╡ 1e3b8a32-65a0-11ef-1882-5f8adae3cc1c
using SymPy

# ╔═╡ 850b7bc2-06ab-4750-8ccc-198d5af35f11
using Plots

# ╔═╡ f5c84ee8-c2ac-4f61-8028-0113df1a8d24
@syms R1 R2 R3 L L1 L2

# ╔═╡ 25b29bfd-117b-46dc-95d9-f341e5d9cb97
md"### A)"

# ╔═╡ bde3e565-093c-4f50-a27d-cbdc97ad7f9a
Leq_a = L

# ╔═╡ 37f24432-cf8e-49e8-b75c-944f7b581f09
Req_a = R2 + (R1*R3)/(R1 + R3)

# ╔═╡ 145d68e4-c1e3-49ff-a429-d4d546ddb33a
tau_a = Leq_a / Req_a

# ╔═╡ 11c00cf8-c958-4f78-b004-0ffb20113cb1
md"### B)"

# ╔═╡ 119e6607-e12a-4e86-a3c9-16a6b830eb60
Leq_b = (L1*L2)/(L1 + L2)

# ╔═╡ af52259f-fda8-4e10-8260-20ed7a788e2c
Req_b = R3 + (R1*R2)/(R1 + R2)

# ╔═╡ 727f4aee-9d07-49f0-9a0c-7aed9539cd78
tau_b = Leq_b / Req_b
